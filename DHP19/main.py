...
def train(exp_name, args, io):
    ...
    if args.label == 'mean':
        # mean label
        # path of train data
        root_train_data_dir = 'D://dataset//dhp19_mean_extract//train//'
        root_valid_data_dir = 'D://dataset//dhp19_mean_extract//test//'
    ...
    for epoch in range(args.epochs):
        ...
        if (epoch + 1) % 1 == 0 and (epoch >= 0) or (epoch == args.epochs - 1):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_batch_size', type=int, default=64, metavar='batch_size',
                        help='Size of train batch)')
    parser.add_argument('--valid_batch_size', type=int, default=64, metavar='batch_size',
    ...
    parser.add_argument('--name', type=str, default='FECNet',
                        help='Name your exp')
